...
export const contextTools = [
    {
        ...
        description: "Get the current spatial layout of the project including all rooms, walls, levels, and their exact coordinates. " +
    ...
    },
    {
        ...
        description: "Get general information about the current project including file path, modification status, level count, room count, wall count, and furniture count.",
        inputSchema: {
            type: "object",
            properties: {},
        },
    ...
    },
    {
        ...
        description: "Get all floor levels with their names, elevations (height from ground), and floor heights (ceiling height).",
        inputSchema: {
            type: "object",
            properties: {},
        },
    ...
    },
    {
        ...
        description: "Create a new floor level. Elevation is the height from ground (Z=0) to the floor surface in centimeters.",
        inputSchema: {
            type: "object",
            properties: {
                name: {
    ...
    },
    {
        ...
        description: "Set which floor level is currently active for editing. New rooms/walls will be created on this level by default.",
        inputSchema: {
            type: "object",
            properties: {
                level: {
