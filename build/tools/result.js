...
export const resultTools = [
    {
        ...
        description: "Open the FDS result viewer window. " +
    ...
    },
    {
        ...
        description: "List available datasets in the loaded FDS results. " +
    ...
    },
    {
        ...
        description: "Extract time-series data at a specific point in the simulation domain. " +
    ...
    },
    {
        ...
        description: "Run ASET (Available Safe Egress Time) analysis at a specified exit location. " +
...
// Handler function
export async function handleResultTool(name, args) {
