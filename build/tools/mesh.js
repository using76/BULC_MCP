...
export const meshTools = [
    {
        ...
        description: "Get a list of all FDS computational meshes. " +
    ...
    },
    {
        ...
        description: "Create a new FDS computational mesh with specified dimensions and cell count. " +
...
// Handler function
export async function handleMeshTool(name, args) {
