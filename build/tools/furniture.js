...
export const furnitureTools = [
    {
        ...
        description: "Get a list of available furniture items from the catalog. " +
        ...
        inputSchema: {
            ...
            properties: {
                category: {
                    type: "string",
                    description: "Filter by category (e.g., 'Seats', 'Tables', 'Beds', 'Doors', 'Windows', 'Lights')",
                },
                search: {
                    type: "string",
    ...
    },
    {
        ...
        description: "Place a furniture item at the specified position. " +
    ...
    },
    {
        ...
        description: "Get a list of all placed furniture with their IDs, positions, and properties. " +
    ...
    },
    {
        ...
        description: "Modify properties of an existing furniture item. " +
...
// Handler function
export async function handleFurnitureTool(name, args) {
