...
export const roomTools = [
    {
        ...
        description: "Create a new rectangular room at the specified position. " +
    ...
    },
    {
        ...
        description: "Create a room with a custom polygon shape defined by an array of points. " +
        ...
        inputSchema: {
            ...
            properties: {
                points: {
                    type: "array",
                    description: "Array of [x, y] coordinate pairs defining the room polygon in centimeters. " +
    ...
    },
    {
        ...
        description: "Get a list of all rooms with their IDs, names, positions, and dimensions. " +
    ...
    },
    {
        ...
        description: "Modify properties of an existing room. Only specified properties will be changed. " +
...
// Handler function
export async function handleRoomTool(name, args) {
