...
import { fetchTools } from "./bridge-client.js";
const require = createRequire(import.meta.url);
const snapshot = require("./tools-snapshot.json");
/** Tools implemented by this server itself rather than forwarded verbatim to the app. */
export const LOCAL_TOOLS = [
    {
        name: "bulc_connection_status",
        description: "Check whether the BULC desktop app is running and reachable, how many tools it exposes, " +
            "and which bridge address this server is using. Call this first when a tool call fails.",
        inputSchema: { type: "object", properties: {}, required: [] },
    },
    {
        name: "get_project_summary",
        description: "Summary of the project currently open in BULC: CHID, title, end time, mesh, and object counts " +
            "(obstacles, fire sources, vents, devices, evacuation agents, sprinkler heads, HVAC terminals).",
        inputSchema: { type: "object", properties: {}, required: [] },
    },
    {
        name: "run_simulation",
        description: "Save the project currently open in BULC and start the simulation. " +
